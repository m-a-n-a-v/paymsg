...
///
/// Converts an ISO 20022 camt.052 (Bank to Customer Account Report) message
/// to a SWIFT MT942 (Interim Transaction Report) message.
///
/// # Errors
///
/// Returns `PaymsgError::TranslationError` if:
/// - Required fields are missing in camt.052
